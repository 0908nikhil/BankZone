# BankZone – Digital Banking Application

BankZone is a full-stack Digital Banking Platform built with Spring Boot and React (Vite).  
...
git clone https://github.com/your-username/BankZone.git
then if you are not in BankZone directory -->
```bash
cd BankZone
```
...
spring.datasource.url=jdbc:mysql://localhost:3306/BankZone
